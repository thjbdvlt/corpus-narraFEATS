...
Le corpus est disponible sous licence [CC BY-NC-SA 4.0](https://creativecommons.org/licenses/by-nc-sa/4.0/deed.fr).
...
- Balzac, [_Le père Goriot_](https://fr.wikisource.org/wiki/Le_P%C3%A8re_Goriot_(1855)) (1855)

### framabook

[Framabook](https://archives.framabook.org/index.html) est une maison d'édition de textes contemporains publiés sous [Licence Art Libre](https://artlibre.org/). (Les textes utilisés dans le corpus ne sont que des extraits, plus ou moins modifiés.)
